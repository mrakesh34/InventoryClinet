        ...
        <>
            ...
            >
                ...
                <div className="flex justify-between items-center p-6 border-b border-gray-100">
                    ...
                    <div 
                        onClick={() => setIsCartOpen(false)}
                        className="w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center cursor-pointer transition-colors z-[9999]"
                        title="Close Cart"
                    >
                        <FaXmark className="w-5 h-5 text-gray-600 pointer-events-none" />
                    </div>
                </div>
                                ...
                                <div key={item.book._id} className="flex gap-4 p-4 bg-white border border-gray-100 rounded-xl shadow-sm">
                                    ...
                                    <div className="flex-1 flex flex-col justify-between">
                                        ...
                                        <div className="flex justify-between items-end mt-2">
                                            <p className="font-bold text-blue-600">${item.book.price?.toFixed(2) || '10.00'}</p>
